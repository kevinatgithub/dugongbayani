...
public class WinnerAdapter extends ArrayAdapter {
    ...
    public WinnerAdapter(@NonNull Context context, ArrayList<WinnerAward> winnerAwards) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(winnerAward.getAward() != null){
            txt2.setText(winnerAward.getAward().getName());
        }

        if(winnerAward.getAgency() != null){
            txt1.setText(winnerAward.getAgency().getName());
        }
